...
| [17](doc/stage-17)      | CI/CD Pipelines                      | Integrate your Terraform configurations and Maester tests into GitHub Actions pipelines. This stage demonstrates how to automate the deployment and security assessment of your Entra ID tenant on every code change, ensuring continuous compliance and security validation. |
| [18](doc/stage-18)      | Multitenant Secret Monitoring                      | Monitor secrets across multiple tenants using a centralized approach. This stage demonstrates how to track and manage secrets in a multitenant environment, ensuring security and compliance via Multitenant App Registration and Federated Identity Credentials. |
